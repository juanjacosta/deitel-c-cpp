/*
    ...
    Propósito: Escribir un programa que implemente el ordenamiento de burbuja de un arreglo
               mediante dos funciones, ordenamientoBurbuja e intercambia. La primera ordena
               el arreglo y la 2da intercambia loe elementos segun la verificacion de
               posiciones.
               Ya que C promueve el ocultamiento de informacion entre funciones, intercambia
               no tiene acceso a los elementos individuales del arreglo en ordenaBurbuja.
               Y ya que ordenaBurbuja necesita intercambiar el orden de los elementos del
               arreglo, pasa cada uno de estos elementos a intercambia mediante una llamada
